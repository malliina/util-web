...
/**
  ...
  */
class GoogleOAuth(clientId: String, clientSecret: String)(implicit mat: Materializer) extends Closeable with Log {
  ...
  private def jsonRequest[T](url: String)(implicit fjs: Reads[T]) =
